...
import 'package:app_test/ui/views/map_view.dart';
      ...
      builder: (context, snapshot) {
        return Scaffold(
          drawer: Container(
              ...
              child: Drawer(
                  child: ListView(
                      ...
                      children: <Widget>[
                    ListTile(
                        leading: Icon(Icons.home, color: Color(0xFF252DB7)),
                        title: Text('Home')),
                    ListTile(
                        ...
                        title: Text('Perfil')),
                    ListTile(
                        leading: Icon(Icons.history, color: Color(0xFF252DB7)),
                    ...
                    ListTile(
                        leading: Icon(Icons.settings, color: Color(0xFF252DB7)),
          ...
          appBar: AppBar(
              ...
              centerTitle: true,
              title: SizedBox(
                  width: 130, child: Image.asset('assets/images/title.png'))),
          body: 
              ListView(
